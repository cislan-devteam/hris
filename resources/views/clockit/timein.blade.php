<x-app-layout>
    ...
    <form action="{{ route('clockit.clockin') }}" method="post" class="mb-6">
        @csrf
        <button type="submit" class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Clock In</button>
    </form>
