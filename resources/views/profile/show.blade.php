<x-app-layout>
    ...
    <div class="px-0 p-1">
        <button type="button" class="px-4 py-2 mb-2 ml-auto display: flex font-bold leading-normal text-center text-white align-middle
    ...
    <div class="grid md:grid-cols-2 gap-4 mt-4">
        ...
        <label class="inline text-sm">
            <span class="text-gray-700 dark:text-gray-400">Email Address</span>
                ...
                focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 dark:text-gray-300 form-input" placeholder="sampleuser@email.com"
                name="email_address" type="text" :value="" required/>
        </label>
        {{-- Mobile --}}
        <div class="z-0 w-full group block text-sm">
            ...
            <input onkeydown="return
                ...
                id="phoneNumber" placeholder="9163451812" maxlength="10" name="contact_number" type="number" :value="" required/>
            </div>
        </div>
    </div>
    ...
    <label class="inline text-sm">
        ...
        <p class="block w-full mt-1 text-sm rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400
            ...
            placeholder="Present Address" id="addressPresent" name="address1" type="text" :value="">649 R. Hidalgo Street, Barangay 307 Quiapo, City of Manila, Metro Manila 1001
        </p>
    </label>
        ...
        <div class="z-0 w-full group block text-sm text">
            <span class="text-gray-700 dark:text-gray-400">Birth Date</span>
                <div class=" w-full relative ">
                    ...
                    dark:bg-gray-700 focus:border-purple-400 focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600
                    dark:text-gray-300" placeholder="YYYY-MM-DD" name="birth_date" type="text" :value="">1993-05-16
                    </p>
            </div>
        </div>
    <!-- Birth Place -->
    <label class="block text-sm">
        <span class="text-gray-700 dark:text-gray-400">Birth Place</span>
            <p class="block w-full mt-1 text-sm rounded border border-gray-300 dark:border-gray-600 
            dark:bg-gray-700 focus:border-purple-400 focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 
            text-gray-900 dark:text-gray-300" name="birth_place" type="text" :value="">San Pedro, Laguna
            </p>
    </label>
</div>
        ...
        <div class="z-0 w-full group block text-sm">
            <label class="block text-sm">
                ...
                <p name="civil_status" id="civil_status" type="text" :value=""
                   ...
                   focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600">Married
                </p>
            </label>
        </div>
        <div class="z-0 w-full group block text-sm text">
            <label class="block text-sm">
                ...
                <p  name="nationality" id="nationality" type="text" :value=""
                    ...
                    focus:ring-purple-200 dark:focus:ring-purple-600">Filipino
                </p>
            </label>
        </div>
    </div>
            ...
            <div class="z-0 w-full group block text-sm">
                <label class="block text-sm">
                    ...
                    'Backspace' || event.key === 'Delete'" oninput="formatTIN(this)"
                        ...
                        [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        id="tin" placeholder="000000000000" maxlength="12" name="tin" type="number" :value="">000–123–456– 001
                    </p>
                </label>
            </div>
            <div class="z-0 w-full group block text-sm text">
                <label class="block text-sm">
                    ...
                    <p onkeydown="return /[0-9-]/.test(event.key) || event.key === 'Backspace' || event.key === 'Delete'"
                        ...
                        [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        id="sss" placeholder="0000000000" maxlength="10" name="sss_num" type="number" :value="">33-5274748-7
                    </p>
                </label>
            </div>
        </div>
        ...
        <div class="z-0 w-full group block text-sm">
            <label class="block text-sm">
                ...
                'Backspace' || event.key === 'Delete'" oninput="formatPagIbig(this)"
                    ...
                    focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 dark:text-gray-300 form-input
                    [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    id="pagIbig" placeholder="000000000000"maxlength="12" name="pagibig_num" type="number" :value="">1023-4567-8090
                </p>
            </label>
        </div>
        <div class="z-0 w-full group block text-sm text">
            <label class="block text-sm">
                ...
                <p onkeydown="return /[0-9-]/.test(event.key) || event.key === 'Backspace' || event.key === 'Delete'"
                    ...
                    focus:border-purple-400 focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 dark:text-gray-300 form-input
                    [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    id="philHealth" placeholder="000000000000" maxlength="12" name="philhealth_num" type="number" :value="('philhealth_num')">02-250001863-5
                </p>
            </label>
        </div>
    </div>
        ...
        <div class="">
            <div class="z-0 w-full group block text-sm">
                ...
                focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 text-gray-900 dark:text-gray-300 form-input"
                    placeholder="Full Name" name="emergency_name" type="text" :value="">Lee Jong-suk
                </p>
            </div>
        </div>
            ...
            <div class="z-0 w-full group block text-sm">
                ...
                <div class="flex mt-1">
                    ...
                    onkeydown="return /[0-9-]/.test(event.key) || event.key ===
                        ...
                        name="emergency_contactnum" type="number" :value="">9123456789
                    </p>
                </div>
            </div>
            <div class="z-0 w-full group block text-sm text">
                <label class="block text-sm">
                    ...
                    <p class="block w-full mt-1 text-sm rounded border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400
                    focus:ring-1 focus:ring-purple-200 dark:focus:ring-purple-600 text-gray-900 dark:text-gray-300 form-input"
                    name="emergency_relationship" type="text" :value="">Spouse
                    </p>
                </label>
            </div>
        </div>
