...
>
 <button
   @click="open = true"
   class="inline-flex items-center py-2 px-6  hover:bg-opacity-95  rounded-md shadow"
 >
 ...
 <template x-teleport="body">
   ...
   >
     ...
     >
       <!-- Modal Title -->
       <div
         class="w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl flex items-center justify-between"
       >
         <h2>Modal Title</h2>
