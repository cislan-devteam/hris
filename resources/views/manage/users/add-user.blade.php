...
<!-- CTA -->
<div
    class="submission-success-message items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-green-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-green"
>
...
<div
    class="submission-fail-message items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-red-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-red"
>
    <div class="flex items-center">
...
<form id="add-user-form">
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <input
            ...
            id="addressCheck"
        />
        <span class="ml-2">Same as Present Address</span>
        </label>
        ...
        <div class="z-0 w-full group block text-sm">
            ...
            <input
                ...
                required
            />
            <span class="unit unitp mr-1 dark:text-gray-300">+63</span>
            </div>
            <span
            id="pfp-error-message"
        ...
        <div class="z-0 w-full group block text-sm">
            <label class="block text-sm">
            <span class="text-gray-700 dark:text-gray-400">Civil Status</span>
            <select
                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            >
                <option>Select your civil status...</option>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="z-0 w-full group block text-sm">
            ...
            <input
                ...
                required
            />
            <span class="unit unitc mr-1 dark:text-gray-300">+63</span>
            </div>
            <span
            id="pfp-error-message"
            class="hidden text-xs text-red-600 dark:text-red-400"
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="z-0 w-full group block text-sm">
            <span class="text-gray-700 dark:text-gray-400">
            Certificate of Clearance from Previous Employer
            </span>
        ...
        <div class="grid md:grid-cols-2 gap-4 mt-4">
        <div class="z-0 w-full group block text-sm">
            <span class="text-gray-700 dark:text-gray-400">Valid ID</span>
            <input
            type="file"
            class="file-upload block w-full mt-1 text-sm p-0 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            id="id1-file-upload"
