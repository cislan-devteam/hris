                ...
                <div class="flex flex-col overflow-y-auto md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                         ...
                         form-input"
                                        placeholder="Name" name="name" type="text":value="old('name')" required
                                        autofocus />
                                    <label class="block mt-2 text-sm" value="{{ __('Email') }}">
                                        <span
                                            class="text-gray-700
                             dark:text-gray-400">Email</span>
                                        <input id="email"
                                    ...
                                    <label class="block mt-2 text-sm" value="{{ __('Password') }}">
                                        <span class="text-gray-700 dark:text-gray-400">{{ __('Register as ') }}</span>
                                        <select name="role_id"
                                            class="block w-full mt-1 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray">
