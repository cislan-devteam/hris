...
class ManageUserController extends Controller
{
    ...
    public function employeeGovId() 
    {
        return view('manage.users.create-gov-id');
    }

    public function employeeGovDocs() 
    {
        return view('manage.users.create-gov-docs');
    }

    public function employeeComDocs() 
    {
        return view('manage.users.create-com-docs');
    }

    public function employeeEmergencyContact() 
    {
        return view('manage.users.create-emergency-contact');
    }
