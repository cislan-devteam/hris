...
Route::get('/manage/xero/employees', [XeroController::class, 'getEmployees'])->name('xero.employees');
Route::get('/manage/xero/invoices', [XeroController::class, 'getInvoices'])->name('xero.invoices');
Route::get('/manage/xero/balancesheet', [XeroController::class, 'getBalanceSheet'])->name('xero.balance.sheet');
Route::get('/manage/xero/payruns', [XeroController::class, 'getPayRuns'])->name('xero.payruns');