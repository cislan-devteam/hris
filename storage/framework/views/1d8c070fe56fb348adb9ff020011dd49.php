...
<?php endif; ?>
              ...
              <label class="block text-sm" value="<?php echo e(__('Name')); ?>">
                <span class="text-gray-700 dark:text-gray-400">Name</span>
                <input id = "name"
                  class="block w-full mt-2 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Name" name="name" type="text":value="old('name')" required autofocus
                />
                <label class="block mt-2 text-sm" value="<?php echo e(__('Email')); ?>">
              ...
              <label class="block mt-2 text-sm" value="<?php echo e(__('Password')); ?>" >
                <span class="text-gray-700 dark:text-gray-400">Password</span>
                <input id = "password"
                  class="block w-full mt-1 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Password" name="password" type="password" required/>
              </label>
              <label class="block mt-2 text-sm" value="<?php echo e(__('Confirm Password')); ?>">
              ...
              <div class="flex mt-4 text-sm">
                <label class="flex items-center dark:text-gray-400">
                  <input
                    type="checkbox"
                    class="text-purple-600  rounded-sm form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                  />
                  <span class="ml-2">
                    I agree to the
              ...
              <button type="submit"
                    class="block w-full px-4 py-2 mt-3 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
...
<?php endif; ?>
<?php /**PATH C:\Users\Christopher Llobrera\Desktop\hris\hris\resources\views/auth/register.blade.php ENDPATH**/ ?>